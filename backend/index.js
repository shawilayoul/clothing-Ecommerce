...
app.use(express.static(path.join(__dirname, 'sleekfrontendreact/dist')));

// API routes here (e.g., app.post('/api/login', ...))
...
app.get('*', (req, res) => {
  res.sendFile(path.join(__dirname, 'sleekfrontendreact/dist', 'index.html'));
})
